  ...
  rule find_high_temps {
    ...
    notfired {
      raise wovyn event "threshold_violation"
        attributes {"temperature":temp, "timestampe":time, "to":sms_number, "from":"3158884750", "message":"Temperature threshold violation detected at " + time + ". Temperature is " + temp}
    }
